...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof hermitepoly, 'function', 'main export is a function' );
	t.end();
});

tape( 'attached to the main export is a `factory` method', function test( t ) {
	t.strictEqual( typeof hermitepoly.factory, 'function', 'has method' );
	t.end();
});
